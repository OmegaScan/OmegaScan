...
int pinger::get_seq() const { return ntohs(icmp_reply.seq); }

char *pinger::get_addr() const { return inet_ntoa(addr.sin_addr); }

double pinger::get_sending_ts() const { return icmp_request.sending_ts; }
